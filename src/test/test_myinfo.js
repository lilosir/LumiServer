...
fetch('https://api.mapbox.com/v4/directions/mapbox.walking/-89.261904,48.422265;-89.231592,48.431652.json?access_token=pk.eyJ1Ijoic3J5Z2ciLCJhIjoiY2lwcThma2hvMDVoYmZubm9iNWR0Mnp2bSJ9.laJCFI9y3Fwn5bvk5T6YYA',contents)
  .then(function(res) {
    return res.json();
  })
  .then(function(json) {
