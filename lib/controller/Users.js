...
module.exports = Ctrl.createController({
  ...
  findSession: ['getMyself', 'getUserFriends', 'updateRecent', 'getRecent', 'isFriend', 'addFriendRequest', 'addFriend'],
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 25:
              _context3.next = 27;
              return Sessions.findOne({ user: user._id }).populate("user", "username avatar nickname").exec();
  ...
  addFriend: function () {
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(_ref7, res, next) {
      var params = _ref7.params;
      var current_user = _ref7.current_user;
      var body = _ref7.body;
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _context11.prev = 3;
              _context11.next = 6;
              return Users.findByIdAndUpdate(params.id, { $push: { 'friends': id } }).exec();
            ...
            case 6:
              ...
              _context11.next = 10;
              return Users.findByIdAndUpdate(id, { $push: { 'friends': params.id } }).exec();
            ...
            case 18:
              ...
              return _context11.abrupt('return', res.send({ message: 'Sorry add friend failed, try agian later', status: 500 }));
    ...
    return function addFriend(_x31, _x32, _x33) {
      return ref.apply(this, arguments);
    };
  }()
