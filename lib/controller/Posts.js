...
module.exports = Ctrl.createController({
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 10;
              return Posts.findById(id).populate("user", "avatar nickname").populate("comments.by", "avatar nickname").exec();
            ...
            case 13:
              ...
              return Posts.find({
                category: category,
                created_at: { $lt: date } }).sort('-created_at').limit(5).populate("user", "avatar nickname").populate("comments.by", "avatar nickname").exec();
            ...
            case 17:
              ...
              return Posts.find({
                category: category,
                created_at: { $gt: date } }).sort('-created_at').limit(5).populate("user", "avatar nickname").populate("comments.by", "avatar nickname").exec();
  ...
  submitComment: function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.prev = 3;
              _context4.next = 6;
              return Posts.findByIdAndUpdate(postId, { $push: { comments: { by: params.id, content: comment } } }).exec();

            case 6:
              result = _context4.sent;
              return _context4.abrupt("return", res.status(200).send({ message: 'comment successfully' }));
    ...
    return function submitComment(_x10, _x11, _x12) {
      return ref.apply(this, arguments);
    };
  }()
